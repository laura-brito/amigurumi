<div class="why-choose-section">
    <div class="container">
        <div class="row justify-content-between">
            <div class="col-lg-6">
                ...
                <div class="row my-5">
                    <div class="col-6 col-md-6">
                        <div class="feature">
                            <div class="icon">
                                <img src="<?php echo BASE_URL; ?>assets/images/truck.svg" alt="Image" class="imf-fluid">
                            </div>
                    ...
                    <div class="col-6 col-md-6">
                        <div class="feature">
                            <div class="icon">
                                <img src="<?php echo BASE_URL; ?>assets/images/support.svg" alt="Image"
                                    class="imf-fluid">
                            </div>
                    ...
                    <div class="col-6 col-md-6">
                        <div class="feature">
                            <div class="icon">
                                <img src="<?php echo BASE_URL; ?>assets/images/return.svg" alt="Image"
                                    class="imf-fluid">
                            </div>
            ...
            <div class="col-lg-5">
                <div class="img-wrap">
                    <img src="<?php echo BASE_URL; ?>assets/images/rabbits.jpeg" alt="Image" class="img-fluid">
                </div>
            </div>
